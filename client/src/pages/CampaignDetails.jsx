        ...
        <div className='flex-[2] flex flex-col gap-[40px]'>
          <div>
            ...
            <div className='mt-[20px] flex flex-row items-center flex-wrap gap-[14px] '>
              ...
              <div>
                <h4 className='font-epilogue font-bold text-[14px] text-white break-all'>{state.owner}</h4>
          ...
          <div>
            ...
            <div className='mt-[20px]'>
              <p className=' font-epilogue font-normal text-[16px] text-[#808191] text-justify leading-[26px]  '>{state.description}</p>
            </div>
          </div>
            ...
            <div className='mt-[20px] flex flex-col gap-4'>
              {
                donators.length > 0 ? donators.map((item, index) => (
                  ...
                  <p className=' font-epilogue font-normal text-[16px] text-[#808191] text-justify leading-[26px]  '>No Donators found. Be the first one!</p>
                )
              }
